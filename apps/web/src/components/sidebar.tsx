...
import { CubeIcon, HouseIcon, MoonIcon, SidebarSimpleIcon, SunIcon } from "@phosphor-icons/react";
  ...
  return (
    <div className="drawer lg:drawer-open">
      ...
      <div className="drawer-content flex min-h-screen flex-col">
        <nav className="sticky top-0 z-30 flex h-15 items-center border-b border-base-300 bg-base-100 px-4">
          <label
      ...
      <div className="drawer-side z-40 is-drawer-close:overflow-visible">
        ...
        <div className="flex min-h-full is-drawer-close:w-15 is-drawer-open:w-64 flex-col bg-base-200">
          <div className="flex h-15 items-center justify-center">
            <CubeIcon className="is-drawer-open:hidden h-6 w-6 text-base-content" weight="bold" />
